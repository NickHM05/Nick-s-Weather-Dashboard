...
function getResult() {
    ...
    $(".forecast").addClass("list-group")
    $(".forecast").append(cityname)
    $(".forecast").append(datetobe)
    ...
    var weather = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + Latti + "&lon=" + Longi + "&exclude=minutely,hourly,alerts&units=imperial&appid=9dd247337ad4b6b047a2f9a30dacaf93";
